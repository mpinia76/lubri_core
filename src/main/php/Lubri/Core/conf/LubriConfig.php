...
class LubriConfig {
	...
	private $appPathCore = "D:/Documents/Mis Webs/lubri_core";

	const PROXIES_NAMESPACE="lubri\\Core\\Proxies";
	const PROXIES_PATH=  "/Proxies";


	const TEST_MODE = true;
	const MAIL_FROM_NAME = "Lubri Tanto";
	const MAIL_FROM = "lubritanto@gmail.com";
