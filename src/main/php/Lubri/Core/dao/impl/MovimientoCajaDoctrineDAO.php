...
use Lubri\Core\dao\IMovimientoCajaDAO;

use Lubri\Core\dao\IMovimientoVentaDAO;

use Lubri\Core\model\MovimientoVenta;

use Lubri\Core\model\ConceptoMovimiento;

use Lubri\Core\dao\IConceptoMovimientoDAO;
...
class MovimientoCajaDoctrineDAO extends CrudDAO implements IMovimientoCajaDAO{
	...
	protected function getClazz(){
		return "Lubri\Core\model\MovimientoCaja";
	}
