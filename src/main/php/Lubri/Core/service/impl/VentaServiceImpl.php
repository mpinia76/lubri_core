...
class VentaServiceImpl extends CrudService implements IVentaService {
	...
	function validateOnAdd( $entity ){
        ...
        if( (!$entity->getKm())&&($entity->getPatente()||$entity->getMarca())){
            throw new ServiceException("venta.km.required");
        }
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::cobrar()
	 */
	public function cobrar(Venta $venta, Cuenta $cuenta, User $user, $montoPagar, $montoActualizado){
		...
		$movimiento->setConcepto( LubriUtils::getConceptoMovimientoVenta() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::anular()
	 */
	public function anular(Venta $venta, User $user){
		...
		if( $venta->getMonto() > $venta->getMontoDebe() ){
			...
			foreach ($movimientos as $movimiento) {
				...
				$contramovimiento->setConcepto( LubriUtils::getConceptoMovimientoAnulacionVenta() );
...
/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::devolver()
	 */
	public function devolver(Venta $venta, Cuenta $cuenta, User $user){
		...
		if( $venta->getMontoDevolucion() > $venta->getMontoDebe() ){
			...
			$movimiento->setConcepto( LubriUtils::getConceptoMovimientoDevolucion() );
			$movimiento->setUser($user);
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::cobrarCtaCte()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::getTotalesDia()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IVentaService::getTotalesMes()
	 */
