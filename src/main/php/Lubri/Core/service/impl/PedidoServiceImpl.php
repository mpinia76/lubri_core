...
use Lubri\Core\model\MovimientoPedido;
...
use Lubri\Core\service\IPedidoService;
...
class PedidoServiceImpl extends CrudService implements IPedidoService {
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IPedidoService::pagar()
	 */
	public function pagar(Pedido $pedido, Cuenta $cuenta, User $user){
		...
		$movimiento->setConcepto( LubriUtils::getConceptoMovimientoPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IPedidoService::anular()
	 */
	public function anular(Pedido $pedido, User $user){
		...
		if( $pedido->getEstado() == EstadoPedido::Pagado ){
			...
			$contramovimiento->setConcepto( LubriUtils::getConceptoMovimientoAnulacionPedido() );
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IPedidoService::recibir()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see src/main/php/Lubri/Core/service/Lubri\Core\service.IPedidoService::anularRecibir()
	 */
