...
class Venta extends Entity{
     ...
     * @return string
     */
    public function getModeloPatente()
    {
        return $this->marca.' '.$this->patente;
    }
	...
	public function __toString(){
		 return $this->getFecha()->format("d/m/Y H:i:s").' '.$this->getModeloPatente().' Kms: '.$this->getKm();
	}
