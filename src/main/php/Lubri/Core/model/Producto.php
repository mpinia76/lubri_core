 ...
 * Producto
 *
 * @Entity @Table(name="lubri_producto")
 *
 * @author Marcos
 */
...
class Producto extends Entity{
    ...
    /**
     * @ManyToOne(targetEntity="Lubri\Core\model\TipoProducto",cascade={"detach"})
    ...
    /**
     * @ManyToOne(targetEntity="Lubri\Core\model\MarcaProducto",cascade={"detach"})
	...
	private $descripcion;
	 ...
	 /**
     * @ManyToOne(targetEntity="Lubri\Core\model\Iva",cascade={"detach"})
	...
	{
		/*$parametroDolar = LubriUtils::getPrecioDolar();
	    $parametroPorcentaje = LubriUtils::getPorcentajePrecioLista();
