 ...
 */
class CuentaCorriente extends \Lubri\Core\model\CuentaCorriente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lubri\\Core\\model\\CuentaCorriente' . "\0" . 'cliente'];
        }
